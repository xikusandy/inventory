...
<?php if($results && $results->num_rows > 0): ?>
    <div class="page-break">
        <div class="sale-head">
            ...
            <strong><?php echo isset($start_date) ? $start_date : ''; ?> TILL DATE <?php echo isset($end_date) ? $end_date : ''; ?></strong>
        </div>
...
<?php else: ?>
    <div class="alert alert-warning text-center">
        <p>Sorry, no sales have been found for the selected dates.</p>
    </div>
<?php endif; ?>
