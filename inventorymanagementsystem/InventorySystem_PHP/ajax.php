 ...
 // find all product
  if(isset($_POST['p_name']) && strlen($_POST['p_name']))
  {
    ...
    if($results = find_all_product_info_by_title($product_title)){
        ...
        $html .= "</td>";
        $html .= "<td><input type=\"text\" class=\"form-control\" name=\"phone_number\">.</td>";
        $html .= "<td><input type=\"text\" class=\"form-control\" name=\"location\"></td>";
        $html .= "<td><input type=\"text\" class=\"form-control\" name=\"building_type\"></td>";
