...
// Fetching monthly sales data for the current year
$year = date('Y');
$sales = monthlySales($year);

if ($sales === false) {
    $msg = "Failed to retrieve monthly sales data for year {$year}.";
    $sales = []; // Initialize $sales as an empty array to prevent undefined variable error
}
?>
                    ...
                    <tbody>
                        <?php foreach ($sales as $index => $sale): ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo isset($sale['quantity']) ? (int)$sale['quantity'] : 0; ?></td>
